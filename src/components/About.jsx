  ...
  return (
    <div className='w-full flex flex-col justify-center text-center gap-[50px]'>
      <div className="text-glow-container">
        <p className='xl:text-[32px] text-glow sm:text-[24px]'>я занимаюсь <span className='text-blue'>backend</span> и 
        <span className='text-blue'>frontend</span> разработкой<br />
